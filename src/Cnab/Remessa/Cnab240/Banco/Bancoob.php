...
//        $boleto->setNumero(Util::numberFormatGeral($boleto->getNumero(), 7)
//            . CalculoDV::bancoobNossoNumero($boleto->getAgencia(), $boleto->getConvenio(), $boleto->getNumero()));
        ...
        $this->add(119, 126, ($boleto->getJuros() !== null && $boleto->getJuros() > 0) ? $boleto->getDataVencimento()->addDay(1)->format('dmY') : '00000000');
    ...
    public function segmentoR(BoletoContract $boleto)
    {
        ...
        $this->add(67, 74, $boleto->getMulta() > 0 ? $boleto->getDataVencimento()->addDay(1)->format('dmY') : '00000000');
